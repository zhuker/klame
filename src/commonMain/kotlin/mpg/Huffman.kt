...
object Huffman {
    ...
    val ht = arrayOf(newhuff( /* 0 */0, tab0), newhuff( /* 2 */0, tab1), newhuff( /* 3 */0, tab2), newhuff( /* 3 */0, tab3), newhuff( /* 0 */0, tab0), newhuff( /* 4 */0, tab5), newhuff( /* 4 */0, tab6), newhuff( /* 6 */0, tab7), newhuff( /* 6 */0, tab8), newhuff( /* 6 */0, tab9), newhuff( /* 8 */0, tab10), newhuff( /* 8 */0, tab11), newhuff( /* 8 */0, tab12), newhuff( /* 16 */0, tab13), newhuff( /* 0 */0, tab0), newhuff( /* 16 */0, tab15),

            newhuff( /* 16 */1, tab16), newhuff( /* 16 */2, tab16), newhuff( /* 16 */3, tab16), newhuff( /* 16 */4, tab16), newhuff( /* 16 */6, tab16), newhuff( /* 16 */8, tab16), newhuff( /* 16 */10, tab16), newhuff( /* 16 */13, tab16), newhuff( /* 16 */4, tab24), newhuff( /* 16 */5, tab24), newhuff( /* 16 */6, tab24), newhuff( /* 16 */7, tab24), newhuff( /* 16 */8, tab24), newhuff( /* 16 */9, tab24), newhuff( /* 16 */11, tab24), newhuff( /* 16 */13, tab24))

    val htc = arrayOf(newhuff( /* 1 , 1 , */0, tab_c0), newhuff( /* 1 , 1 , */0, tab_c1))

    class newhuff(val linbits: Int, val table: ShortArray)
}
