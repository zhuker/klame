...
class DCT64 {
    ...
    private lateinit var tabInit: TabInit

    fun setModules(ti: TabInit) {
        tabInit = ti
    }

    private fun dct64_1(out0: FloatArray, out0Pos: Int, out1: FloatArray, out1Pos: Int,
                        b1: FloatArray, b2: Int, samples: FloatArray, samplesPos: Int) {

        run {
            val costab = tabInit.pnts[0]
        ...
        run {
            val cos0 = tabInit.pnts[3][0]
            val cos1 = tabInit.pnts[3][1]
	 ...
	 */
    fun dct64(a: FloatArray, aPos: Int, b: FloatArray, bPos: Int, c: FloatArray,
              cPos: Int) {
