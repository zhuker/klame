...
class TabInit {
    ...
    var decwin = FloatArray(512 + 32)
    var pnts = arrayOf(cos64, cos32, cos16, cos8, cos4)
    /* *INDENT-ON* */

    internal fun make_decode_tables(scaleval: Long) {
        var scaleval = scaleval
        var i: Int
        var j: Int
        var k: Int
        var kr: Int
        ...
        while (i < 5) {
            ...
            k = 0
            while (k < kr) {
                costab[k] = (1.0 / (2.0 * Math.cos(MPG123.M_PI * (k.toDouble() * 2.0 + 1.0) / divv.toDouble()))).toFloat()
                k++
            }
            i++
        }
        ...
        while (i < 256) {
            if (table < 512 + 16) {
                decwin[table + 0] = (dewin[j] * scaleval).toFloat()
    ...
    companion object {
        private val cos64 = FloatArray(16)
        private val cos32 = FloatArray(8)
        private val cos16 = FloatArray(4)
        private val cos8 = FloatArray(2)
        private val cos4 = FloatArray(1)
