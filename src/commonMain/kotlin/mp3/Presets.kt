...
class Presets {
    ...
    private fun apply_vbr_preset(gfp: LameGlobalFlags, a: Int,
        ...
        if (enforce != 0)
            internal_flags.nsPsy.attackthre = p.st_lrm
        else if (Math.abs(internal_flags.nsPsy.attackthre - -1) <= 0)
            internal_flags.nsPsy.attackthre = p.st_lrm
        // SET_OPTION(short_threshold_lrm, set.st_lrm, -1);
        if (enforce != 0)
            internal_flags.nsPsy.attackthre_s = p.st_s
        else if (Math.abs(internal_flags.nsPsy.attackthre_s - -1) <= 0)
            internal_flags.nsPsy.attackthre_s = p.st_s
    ...
    private fun apply_abr_preset(gfp: LameGlobalFlags, preset: Int,
        ...
        if (enforce != 0)
            internal_flags.nsPsy.attackthre = abr_switch_map[r].st_lrm
        else if (Math.abs(internal_flags.nsPsy.attackthre - -1) <= 0)
            internal_flags.nsPsy.attackthre = abr_switch_map[r].st_lrm
        // SET_OPTION(short_threshold_lrm, abr_switch_map[r].st_lrm, -1);
        if (enforce != 0)
            internal_flags.nsPsy.attackthre_s = abr_switch_map[r].st_s
        else if (Math.abs(internal_flags.nsPsy.attackthre_s - -1) <= 0)
            internal_flags.nsPsy.attackthre_s = abr_switch_map[r].st_s
